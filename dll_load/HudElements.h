...
game_hudelem_s* (__cdecl *HudElem_Alloc)(int clientIndex, int TeamNum) = (game_hudelem_s*(*)(int, int))0x821DF9C0;

int (__cdecl *G_LocalizedStringIndex)(const char* String) = (int(*)(const char*))0x8220C838;

int (__cdecl *G_MaterialIndex)(const char* Name) = (int(*)(const char*))0x8220C9F8;
