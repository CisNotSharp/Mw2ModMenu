...
void (_cdecl *SV)(int clientNum, int type, const char *text) = (void(*)(int,int,const char*))0x82254940;

bool (_cdecl *Dvar_GetBool)(const char* DvarName) = (bool(*)(const char*))0x8229EF58;

const char* (_cdecl *Dvar_GetString)(const char* Dvar) = (const char*(*)(const char*))0x8229F118;

float (_cdecl *Dvar_GetFloat)(const char *Dvar) = (float(*)(const char*))0x8229F028;

int (_cdecl *Dvar_GetInt)(const char *Dvar) = (int(*)(const char*))0x8229EFC0;

unsigned long (_cdecl *getClientState)(int clientNum) = (unsigned long(*)(int))0x821E66A8;

void (_cdecl *SV_Cmd_TokenizeString)(const char *text_in) = (void(*)(const char*))0x82225348;
 
void (_cdecl *ClientCommand)(unsigned long clientIndex) = (void(*)(unsigned long))0x821DC638;

void (_cdecl *SV_Cmd_EndTokenizedString)() = (void(*)())0x82225368;

const char * (_cdecl *G_SoundAliasIndex)(const char *name) = (const char*(*)(const char*))0x8220D048;
